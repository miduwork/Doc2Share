  ...
  return (
    <footer className="border-t border-line py-8">
      <div className="section-container flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-center text-sm text-muted">
        <span>© Doc2Share. Tài liệu được bảo vệ bản quyền.</span>
        <span className="flex items-center gap-4">
          <Link href="/terms" className="hover:text-primary hover:underline">Điều khoản</Link>
          <Link href="/privacy" className="hover:text-primary hover:underline">Chính sách bảo mật</Link>
          <Link href="/contact" className="hover:text-primary hover:underline">Liên hệ / FAQ</Link>
        </span>
      </div>
    </footer>
  );
