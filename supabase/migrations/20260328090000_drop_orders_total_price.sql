-- Phase B (cleanup): drop orders.total_price and ensure no DB functions still depend on it.
-- NOTE: there is an existing migration (20260327120000_*) that may have re-introduced
-- total_price usage inside create_checkout_order(). This migration overrides it again
